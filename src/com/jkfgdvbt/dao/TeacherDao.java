...
public class TeacherDao extends BaseDao{
	public boolean addTeacher(TeacherModel teacher) {
		...
		try {
			...
			prst.setString(2, teacher.getSex());
			prst.setString(3, teacher.getTitle());
			prst.setInt(4, teacher.getAge());
			prst.setString(5, teacher.getPassword());
	...
	public List<TeacherModel> getTeacherList(TeacherModel teacher) {
		// TODO Auto-generated method stub
		List<TeacherModel> retList = new ArrayList<TeacherModel>();
		StringBuffer sql = new StringBuffer("select * from s_teacher");
		if(!StringUtil.isEmpty(teacher.getName())) {
			sql.append(" where name like '%" + teacher.getName() + "%'");
		}
	...
	public boolean update(TeacherModel teacher) {
	...
	public TeacherModel login(TeacherModel teacher) {
		String sql = "select * from s_teacher where name=? and password=?";
		TeacherModel teacherRst = null;
		try {
	...
	public String editPassword(TeacherModel teacher, String newPassword) {
		// TODO Auto-generated method stub
